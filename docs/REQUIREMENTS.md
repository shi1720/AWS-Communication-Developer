...
| Reproducible working application    | Fresh setup using README plus meaningful passing tests                                              | **127 automated tests and production build passed; hosted recovery and security paths verified**                                                                                  |
