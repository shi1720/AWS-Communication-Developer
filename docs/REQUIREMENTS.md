...
| New work within submission period   | Repository history and disclosure of any incorporated prior work                                    | **Build began 22 September 2026; repository history and AI-assisted development disclosure present**                                                                              |
...
| Reproducible working application    | Fresh setup using README plus meaningful passing tests                                              | **115 automated tests and production build passed; hosted recovery and security paths verified**                                                                                  |
| Source repository and assets        | Reachable GitHub/GitLab URL with all required source and setup instructions                         | **Public repository verified; final changes must be pushed to main before submission**                                                                                            |
| Appropriate repository access       | Public repository with detectable open-source licence; or private access for both judging addresses | **Public repository and detectable MIT license verified**                                                                                                                         |
| Architecture diagram                | Diagram matching actual release components and data flow                                            | **[Public preview](assets/preview-architecture.svg) matches Firebase/Cloud Run/Firestore; [intended AWS design](assets/architecture.svg) remains undeployed**                     |
| English project description         | Final, evidence-aligned [SUBMISSION.md](SUBMISSION.md) text                                         | **Draft prepared**                                                                                                                                                                |
| Approximately three-minute video    | Real product footage; public YouTube/Vimeo link; no unlicensed media                                | **Finished 2:46 narrated and captioned walkthrough at [the hosted watch page](https://secondcrate.web.app/demo.html); required public YouTube/Vimeo publication remains pending** |
| Deployed project and judge access   | Reachable URL and usable free access/testing instructions                                           | **[Public rehearsal](https://secondcrate.web.app) verified; isolated no-key demo available. AWS runtime qualification remains pending**                                           |
...
| Ownership/disclosures               | Contributor rights, licences and truthful AI/prior-work disclosure                                  | **MIT license, third-party notices, original artwork attribution and AI-assisted development disclosure present; final video credits must match its assets**                      |
