...
Current evidence: [Firebase deployment](evidence/firebase-deployment.json), [hosted workflow](evidence/firebase-http-smoke.json), [hosted security](evidence/firebase-security-smoke.json), [post-verification AWS status](evidence/aws-post-verification.json), [responsive browser checks](evidence/responsive-browser.json) and [order follow-up regression](evidence/hosted-order-followup.json). The expanded 115-test application release passed [Linux CI](https://github.com/shi1720/AWS-Communication-Developer/actions/runs/35709843584) on commit `49741aa`, including infrastructure synthesis, compiled HTTP smoke and the dependency audit.
